...
import com.koratur.algorithms.TaskScheduler621;
...
public class TaskScheduler621Test {
    ...
    public void Test1(){
        ...
        var t = new TaskScheduler621();

        Assert.assertEquals(8, t.leastInterval(new char[]{'A', 'A', 'A', 'B', 'B', 'B'}, 2));
    ...
    public void Test2(){
        ...
        Assert.assertEquals(10, t.leastInterval(new char[]{'A', 'A', 'A', 'B', 'B', 'B', 'C', 'A'}, 2));
    ...
    public void Test3(){
        ...
        Assert.assertEquals(6, t.leastInterval(new char[]{'A', 'A', 'A', 'B', 'B', 'B'}, 0));
